...
class ShiftDisplay {
	...
	public:
		...
		void setAt(int section, const byte customs[]);
		void setAt(int section, byte customs[]); // custom characters (encoded in abcdefgp format), array length must match defined section size
